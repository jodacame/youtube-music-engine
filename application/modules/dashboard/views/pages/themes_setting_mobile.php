<?php
$setting_file = './assets/css/themes/'.$this->config->item("theme_mobile").'/'.$this->config->item("theme_mobile").'.conf';
$config = array();
		 		...
		 		<div class="box-body">
		 			<div class="col-md-3">
		 					<div class="col-md-12">
							      ...
							      <img src="<?php echo base_url(); ?>assets/css/themes/<?php echo $this->config->item("theme_mobile"); ?>/<?php echo $this->config->item("theme_mobile"); ?>.png" class="img-responsive thumbnail" style="width:100%">							      
					...
					<div class="col-md-9">
					  ...
					  <div class="form-group col-md-6">	
					   ...
					   <?php 
					    ...
					    if(file_exists( './assets/css/themes/'.$this->config->item("theme_mobile").'/skins/'))
					    {
					    ?>
					   ...
					   <div class="form-group col-md-12">	
					    <label>Skin Color</label>
					     <select  name="skin_color" class="form-control">
						    ...
						    $skin = directory_map( './assets/css/themes/'.$this->config->item("theme_mobile").'/skins/');
