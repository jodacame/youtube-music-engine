  ...
  <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">     
                        ...
                        <li class="active" id="stopRadio" style="display:none" onClick="stop_radio();"><a href="#"><img src="<?php echo base_url(); ?>assets/images/bars.gif"> <?php echo ___("label_stop_radio"); ?></a></li>                                                 
                            ...
                            <li class="btn-download-mp3" title="<?php echo ___("label_download"); ?>" >
                            ...
                            <?php } ?>
                             <?php if($this->config->item('volume_control') == '1'){ ?>
                              ...
                              <li class="hidden-md hidden-sm"><a href="#">
                                 <i class="fa fa-volume-up"></i> <input type="text" id="volume" class="col-xs-12" value="" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="100" data-slider-orientation="horizontal" data-slider-selection="after"data-slider-tooltip="hide"> 
                              </a>
                            </li>                           
    ...
    <div id="player-container">
        ...
        <div class="controls" id="controls">         
            ...
            {
              ?><button class="btn btn-warning amazon btn-download-mp3" title="<?php echo ___("label_download"); ?>"><i class="fa fa-shopping-cart"></i> </button><?php
            }
            ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
       <div id="playlist-items" class="exclude">
          ...
          <div class="sidebar-menu">
            <ul class="nav nav-sidebar">              
                <?php   if($this->config->item('use_database') == 1 && is_logged()){ ?>            
                        <li onClick="profile()" id="MyProfile" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo $this->session->userdata('nickname'); ?>"><a class='truncate' href="#"><i class=""><img class="img-responsive img-circle" style="width:50px;margin-left:15px" src="<?php echo $this->session->userdata('avatar'); ?>"></i><span><?php echo $this->session->userdata('nickname'); ?></span></a></li>
                    <?php } ?>

              <li data-placement="right" class="btn-search-box" data-toggle="tooltip"  data-title="<?php echo ___("label_search"); ?>"><a href="#"><i class="fa fa-search"></i> <span><?php echo ___("label_search"); ?></span></a></li>
              <li id="topArtist" data-placement="right" data-toggle="tooltip"  data-title="<?php echo ___("label_artist"); ?>"><a href="#"><i class="fa fa-star-o"></i> <span><?php echo ___("label_artist"); ?></span></a></li>
              <li id="topTrack" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_track"); ?>"><a href="#"><i class="fa fa-music"></i><span><?php echo ___("label_track"); ?></span></a></li>                                                                
            </ul>
              ...
              <ul class="nav nav-sidebar" id="changePlaylist">   
                        ...
                        <?php for($x=1;$x<=intval($this->config->item("nplaylist"));$x++)
                                  {
                                    ?><li  data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_load_playlist"); ?> <?php echo $x; ?>" data-playlist="<?php echo $x; ?>" class="<?php if(intval($this->config->item("nplaylist")) == '1'){ echo 'hide'; } ?> playlist_<?php echo $x; ?> text-muted"><a href="#"><i class="fa fa-circle-o"></i><span><?php echo ___("label_load_playlist"); ?> <?php echo $x; ?></span></a></li><?php
                                  }
                                  if($this->config->item('use_database') == 1 && is_logged())
                                  {
                                    ?>
                                    <li class="divider"></li>                                
                                      <li onClick="myPlaylist()" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_save_as_playlist"); ?>"><a href="#" id="save_as_playlist"><i class="fa fa-save"></i><span><?php echo ___("label_save_as_playlist"); ?></span></a></li>
                                      <li onClick="myPlaylist()"  id="musicFolder" data-placement="right"  data-toggle="tooltip"  data-title=" <?php echo ___("label_music_folder"); ?>"><a href="#" id="save_as_playlist"><i class="fa fa-folder-open-o"></i><span><?php echo ___("label_music_folder"); ?></span></a></li>
                                ...
                                <li onClick="exportPlayList();" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_export_playlist"); ?>"><a href="#"><i class="fa fa-download"></i><span><?php echo ___("label_export_playlist"); ?></span></a></li>
                                <li onClick="importPlayList();" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_import_playlist"); ?>"><a href="#"><i class="fa fa-upload"></i><span><?php echo ___("label_import_playlist"); ?></span></a></li>
                                <?php } ?>
                                <li  onClick="clearPlaylist();" data-placement="right"  data-toggle="tooltip"  data-title="<?php echo ___("label_clear_playlist"); ?>"><a href="#"><i class="fa fa-trash-o"></i><span><?php echo ___("label_clear_playlist"); ?></span></a></li>
                      </ul>
        ...
        <div id="activitySider" class="hidden-xs">
          <ul class="list-group">
          </ul>
        </div>
        <div class="main">
