  ...
  <div class="col-xs-12 col-md-4 col-lg-3">
    <div class="thumbnail" style="background:url('<?php echo $image; ?>') no-repeat top center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;  background-size: cover;">
      ...
      <div class="caption">
        ...
        <p>
        	<button class="btn btn-danger" style="width:100%" title="Album Info" onclick="getTracksAlbum('<?php echo addslashes($value->name); ?>','<?php echo addslashes($value->artist->name); ?>');"><i class="fa fa-folder-o"></i> Album Information</button>                                                     
        </p>
      </div>
    </div>
  </div>	
