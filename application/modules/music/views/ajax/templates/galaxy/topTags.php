...
<?php if($this->config->item("ads_refresh") == '1'){ ?>
  ...
  <div class="page-header">
    ...
    <button class="btn btn-warning pull-right" onclick="start_radio('<?php echo addslashes($top->tracks->track[$itemRand]->name); ?>','<?php echo addslashes($top->tracks->track[$itemRand]->artist->name); ?>','<?php echo $image; ?>')"><i class="fa fa-rss"></i> <?php echo ___("label_start_radio"); ?></button>
<div class="btn-group pull-right">
