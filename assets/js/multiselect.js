...
!function ($) {
  ...
  * ====================== */
  ...
  var MultiSelect = function (element, options) {
    ...
    this.$selectionUl = $('<ul/>', { 'class': "ms-list sortable", 'tabindex' : '-1' });
    this.scrollTo = 0;
  ...
  MultiSelect.prototype = {
    ...
    'generateLisFromOption' : function(option, index, $container){
      ...
      if(extra == 'undefined' || extra == undefined)
        extra = '';
      var selectableLi = $('<li '+attributes+'><span>'+that.escapeHTML($option.text())+extra+'</span></li>'),
